...
class CIHomeProfilePresenter @Inject constructor(useCaseHandler: UseCaseHandler, private var homeUseCase: CIHomeUseCase) : RosiePresenter<CIHomeProfilePresenter.View>(useCaseHandler) {
